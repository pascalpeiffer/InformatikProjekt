...
public class ResourceManager {
    ...
    public static BufferedImage SCENE_SPAWN_BACKGROUND;
    ...
    public static void loadImageResources() throws IOException {
        ...
        PLAYER = ImageIO.read(Objects.requireNonNull(ResourceManager.class.getResource("/player/Player.png")));

        SCENE_SPAWN_BACKGROUND = ImageIO.read(Objects.requireNonNull(ResourceManager.class.getResource("/scenes/spawn/SpawnSceneBackground.png")));
    }
